                ...
                <div class="w-full flex flex-col font-bold rounded-md overflow-clip text-sm">
                  <For each={Object.entries(project.data?.analysis.constructs ?? {})}>
                    {([name, construct]) => (
                      <div
                        class={cn(
                          "p-3 w-full flex flex-col gap-2.5 border border-neutral-200 dark:border-neutral-800 items-center justify-between border-b-0 last:border-b first:rounded-t-md last:rounded-b-md transition-all duration-300 h-auto overflow-clip",
                          {
                            ...
                            {(c) => (
                              <>
                                <div class="w-full flex flex-col justify-between">
                                  ...
                                  <div
                                    class={cn("w-full flex flex-col gap-2.5 text-black dark:text-white overflow-clip", {
                                  ...
                                  >
                                    ...
                                    <div class="w-full flex flex-row items-center gap-2.5">
                                      ...
                                      <A
                                        href={`${project.data?.remote}/tree/main/${c().meta.file}#L${c().meta.line}`}
                                        target="_blank"
                                        rel="external"
                                        class="text-teal-500"
                                      >

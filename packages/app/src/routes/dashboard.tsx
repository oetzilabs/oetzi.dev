...
const Sync = () => {
  const [user] = useAuth();
  // create a timer that gets triggered if the sync failed, to allow the user to retry
  ...
  return (
    <button
      class={cn("flex flex-row items-center justify-center gap-3 px-2.5 py-1", {
        ...
        "bg-neutral-50 dark:bg-neutral-950 rounded-md text-black dark:text-white cursor-not-allowed hover:bg-neutral-50 dark:hover:bg-neutral-900 active:bg-neutral-50 dark:active:bg-neutral-800":
          syncProjects.isLoading,
        "bg-green-50 dark:bg-green-950 rounded-md text-green-900 dark:text-green-50 cursor-not-allowed hover:bg-green-50 dark:hover:bg-green-900 active:bg-green-50 dark:active:bg-green-800":
      ...
      disabled={syncProjects.isLoading}
      onClick={async () => {
...
const Dashboard = () => {
  ...
  const userProjects = createQuery(
    ...
    },
    {
      get enabled() {
        const u = user();
        return u.isAuthenticated && u.token !== null;
      },
          ...
          >
            <Match when={projects.isSuccess}>
              <For
                each={projects.data}
                fallback={
                  <div class="col-span-4 w-full p-20 flex flex-col items-center justify-center bg-neutral-50 dark:bg-neutral-950 gap-6 rounded-md">
                    <h3 class="text-xl font-bold">There is currently no project made</h3>
                    <p class="text-lg font-medium">Please check in later!</p>
                  </div>
                }
              >
                {(project) => (
          ...
          >
            <Match when={userProjects.isSuccess}>
              <For
                ...
                fallback={
                  <div class="col-span-4 w-full p-10 flex flex-col items-center justify-center bg-neutral-50 dark:bg-neutral-950 gap-6">
